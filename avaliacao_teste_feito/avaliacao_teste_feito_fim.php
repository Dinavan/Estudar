...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["Estudar_____avaliacao_teste_feito"]))
   {
      unset($_SESSION['session_sec_aplicacao']["Estudar_____avaliacao_teste_feito"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['avaliacao_teste_feito']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['avaliacao_teste_feito']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['avaliacao_teste_feito']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['avaliacao_teste_feito']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['avaliacao_teste_feito']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>avaliacao_teste_feito</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['avaliacao_teste_feito']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['avaliacao_teste_feito']['embutida_filho'] as $ind => $sc_init)
          {
