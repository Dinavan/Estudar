...
class avaliacao_teste_feito_rtf
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   //---- 
   function avaliacao_teste_feito_rtf()
   {
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo   .= ".rtf";
      $this->Tit_doc    = "avaliacao_teste_feito.rtf";
   }
   ...
   function gera_texto_tag()
   {
     global $nm_lang;
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['avaliacao_teste_feito']['rtf_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['avaliacao_teste_feito']['rtf_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['avaliacao_teste_feito']['rtf_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['avaliacao_teste_feito']['rtf_name']);
      }
...
$_SESSION['scriptcase']['avaliacao_teste_feito']['contr_erro'] = 'off'; 
   ...
   function NM_export_u512969981_questoes_u512969981_questao()
   {
         ...
         $this->u512969981_questoes_u512969981_questao = str_replace('<', '&lt;', $this->u512969981_questoes_u512969981_questao);
         $this->u512969981_questoes_u512969981_questao = str_replace('>', '&gt;', $this->u512969981_questoes_u512969981_questao);
         $this->Texto_tag .= "<td>" . $this->u512969981_questoes_u512969981_questao . "</td>\r\n";
   }
   //----- resp
   function NM_export_resp()
   {
         ...
         $this->resp = str_replace('<', '&lt;', $this->resp);
         $this->resp = str_replace('>', '&gt;', $this->resp);
         $this->Texto_tag .= "<td>" . $this->resp . "</td>\r\n";
   }
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['avaliacao_teste_feito']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['avaliacao_teste_feito']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
