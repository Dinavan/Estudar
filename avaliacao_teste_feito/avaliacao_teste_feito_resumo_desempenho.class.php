...
class avaliacao_teste_feito_resumo
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   var $link_graph_tot; 
   var $Tot_ger; 
   var $array_total_u512969981_questoes_teste;
   var $array_total_u512969981_questoes_aluno;
   var $array_total_resp;
   ...
   var $conv_col;
   var $count_ger;
   var $sc_proc_quebra_u512969981_questoes_teste;
   var $count_u512969981_questoes_teste;
   var $sc_proc_quebra_u512969981_questoes_aluno;
   var $count_u512969981_questoes_aluno;
   var $sc_proc_quebra_resp;
   var $count_resp;

   //---- 
   function avaliacao_teste_feito_resumo($tipo = "")
   {
      ...
      $this->array_total_u512969981_questoes_teste = array();
      $this->array_total_u512969981_questoes_aluno = array();
      $this->array_total_resp                      = array();
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
       ...
       if ($tmp_pos !== false && !is_array($this->u512969981_questoes_aluno))
       {
       ...
       if ($tmp_pos !== false && !is_array($this->u512969981_questoes_teste))
       {
           $this->u512969981_questoes_teste = substr($this->u512969981_questoes_teste, 0, $tmp_pos);
       }
     } 
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['avaliacao_teste_feito']['where_resumo']);
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['avaliacao_teste_feito']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['avaliacao_teste_feito']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['avaliacao_teste_feito']['res_hrz'];
      $dir_raiz          = strrpos($_SERVER['PHP_SELF'],"/") ;  
      $dir_raiz          = substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['avaliacao_teste_feito']['array_graf_pdf'] = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['avaliacao_teste_feito']['where_resumo'] = "";
      $this->inicializa_vars();
      $this->total->quebra_geral();
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['avaliacao_teste_feito']['tot_geral'] as $ind => $val)
      {
           if ($ind > 0)
           {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['avaliacao_teste_feito']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['avaliacao_teste_feito']['contr_total_geral'] == "OK")
      {
          $this->array_total_u512969981_questoes_teste = $_SESSION['sc_session'][$this->Ini->sc_page]['avaliacao_teste_feito']['arr_total']['u512969981_questoes_teste'];
          $this->array_total_u512969981_questoes_aluno = $_SESSION['sc_session'][$this->Ini->sc_page]['avaliacao_teste_feito']['arr_total']['u512969981_questoes_aluno'];
          $this->array_total_resp = $_SESSION['sc_session'][$this->Ini->sc_page]['avaliacao_teste_feito']['arr_total']['resp'];
      }
      else
      {
          $this->array_total_u512969981_questoes_teste = array();
      ...
      $this->array_total_geral[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['avaliacao_teste_feito']['tot_geral'][1];
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['avaliacao_teste_feito']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['avaliacao_teste_feito']['tot_geral'][1] == 0)
      {
      ...
      $this->drawMatrix();
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['avaliacao_teste_feito']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['avaliacao_teste_feito']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['avaliacao_teste_feito']['arr_total']['u512969981_questoes_teste'] = $this->array_total_u512969981_questoes_teste;
      $_SESSION['sc_session'][$this->Ini->sc_page]['avaliacao_teste_feito']['arr_total']['u512969981_questoes_aluno'] = $this->array_total_u512969981_questoes_aluno;
      $_SESSION['sc_session'][$this->Ini->sc_page]['avaliacao_teste_feito']['arr_total']['resp'] = $this->array_total_resp;
      $_SESSION['sc_session'][$this->Ini->sc_page]['avaliacao_teste_feito']['contr_array_resumo'] = "OK";
   }
   ...
   function completeMatrix()
   {
       ...
       //-----
       $this->comp_field_nm = array(
           'u512969981_questoes_teste' => 0,
           'u512969981_questoes_aluno' => 1,
           'resp' => 2,
       );
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['avaliacao_teste_feito']['summarizing_fields_order']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['avaliacao_teste_feito']['summarizing_fields_order'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['avaliacao_teste_feito']['summarizing_fields_order'];
       }
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['avaliacao_teste_feito']['summarizing_fields_display']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['avaliacao_teste_feito']['summarizing_fields_display'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
           }
       }
       else
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['avaliacao_teste_feito']['summarizing_fields_display'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['avaliacao_teste_feito']['summarizing_fields_display'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['avaliacao_teste_feito']['summarizing_fields_display'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['avaliacao_teste_feito']['summarizing_fields_display'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['avaliacao_teste_feito']['summarizing_fields_display'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['avaliacao_teste_feito']['summarizing_fields_display'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['avaliacao_teste_feito']['summarizing_fields_display'] as $i_sum => $d_sum)
           {
               $this->comp_sum_display[$i_sum] = $d_sum['display'];
           }
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['avaliacao_teste_feito']['summarizing_fields_control']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['avaliacao_teste_feito']['summarizing_fields_control'] = array(
               'NM_Count' => array(
       ...
       //-----
       foreach ($this->array_total_u512969981_questoes_teste as $i_u512969981_questoes_teste => $d_u512969981_questoes_teste) {
           if (!in_array($i_u512969981_questoes_teste, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_u512969981_questoes_teste[2] ] = $d_u512969981_questoes_teste[1];
               $this->comp_label[0][ $d_u512969981_questoes_teste[2] ] = $d_u512969981_questoes_teste[1];
           }
           foreach ($this->array_total_u512969981_questoes_aluno[$i_u512969981_questoes_teste] as $i_u512969981_questoes_aluno => $d_u512969981_questoes_aluno) {
               if (!in_array($i_u512969981_questoes_aluno, $this->comp_label[1][ $d_u512969981_questoes_teste[2] ], true)) {
                   $this->comp_index[1][ $d_u512969981_questoes_aluno[2] ] = $d_u512969981_questoes_aluno[1];
                   $this->comp_label[1][ $d_u512969981_questoes_teste[2] ][ $d_u512969981_questoes_aluno[2] ] = $d_u512969981_questoes_aluno[1];
               }
               foreach ($this->array_total_resp[$i_u512969981_questoes_teste][$i_u512969981_questoes_aluno] as $i_resp => $d_resp) {
                   if (!in_array($i_resp, $this->comp_label[2][ $d_u512969981_questoes_teste[2] ][ $d_u512969981_questoes_aluno[2] ], true)) {
                       $this->comp_index[2][ $d_resp[2] ] = $d_resp[1];
                       $this->comp_label[2][ $d_u512969981_questoes_teste[2] ][ $d_u512969981_questoes_aluno[2] ][ $d_resp[2] ] = $d_resp[1];
                   }
               }
           }
       }
       ...
       //-----
       $this->comp_links_fl = array(
           array('name' => 'u512969981_questoes.teste', 'prot' => '@aspass@'),
           array('name' => 'u512969981_questoes.aluno', 'prot' => '@aspass@'),
           array('name' => 'resp', 'prot' => '@aspass@'),
       );
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['avaliacao_teste_feito']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['avaliacao_teste_feito']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['avaliacao_teste_feito']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['avaliacao_teste_feito']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['avaliacao_teste_feito']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['avaliacao_teste_feito']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['avaliacao_teste_feito']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['avaliacao_teste_feito']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['avaliacao_teste_feito']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['avaliacao_teste_feito']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['avaliacao_teste_feito']['pivot_tabular'] = $this->comp_tabular;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['avaliacao_teste_feito']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['avaliacao_teste_feito']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['avaliacao_teste_feito']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['avaliacao_teste_feito']['pivot_order_level'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['avaliacao_teste_feito']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['avaliacao_teste_feito']['pivot_order_sort'] = '';
       }
       if (isset($_POST['change_sort']) && 'Y' == $_POST['change_sort'])
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['avaliacao_teste_feito']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['avaliacao_teste_feito']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['avaliacao_teste_feito']['pivot_order_col']  = $_POST['sort_col'];
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['avaliacao_teste_feito']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['avaliacao_teste_feito']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['avaliacao_teste_feito']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['avaliacao_teste_feito']['pivot_order'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['avaliacao_teste_feito']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['avaliacao_teste_feito']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['avaliacao_teste_feito']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['avaliacao_teste_feito']['pivot_tabular'];
       ...
       //-----
       foreach ($this->comp_label[0] as $i_u512969981_questoes_teste => $l_u512969981_questoes_teste) {
           if (isset($this->array_total_u512969981_questoes_teste[$i_u512969981_questoes_teste])) {
               $this->comp_group[$i_u512969981_questoes_teste] = array();
           }
           foreach ($this->comp_label[1][$i_u512969981_questoes_teste] as $i_u512969981_questoes_aluno => $l_u512969981_questoes_aluno) {
               if (isset($this->array_total_u512969981_questoes_aluno[$i_u512969981_questoes_teste][$i_u512969981_questoes_aluno])) {
                   $this->comp_group[$i_u512969981_questoes_teste][$i_u512969981_questoes_aluno] = array();
               }
               foreach ($this->comp_label[2][$i_u512969981_questoes_teste][$i_u512969981_questoes_aluno] as $i_resp => $l_resp) {
                   if (isset($this->array_total_resp[$i_u512969981_questoes_teste][$i_u512969981_questoes_aluno][$i_resp])) {
                       $this->comp_group[$i_u512969981_questoes_teste][$i_u512969981_questoes_aluno][$i_resp] = array();
                   }
               }
           }
       }
   ...
   function getCompData($level, $params = array()) {
       if (0 == $level) {
           $return = $this->array_total_u512969981_questoes_teste;
       }
       elseif (1 == $level) {
           $return = $this->array_total_u512969981_questoes_aluno;
       }
       elseif (2 == $level) {
           $return = $this->array_total_resp;
       }
   ...
   function buildChart()
   {
       ...
       $this->comp_chart_config = array(
           '0|0' => array(
               ...
               'show_sub' => true,
               'subtitle' => "",
               'label_x'  => $this->getChartText(strip_tags("Teste")),
           ...
           '1|0' => array(
               ...
               'show_sub' => true,
               'subtitle' => "",
               'label_x'  => $this->getChartText(strip_tags("Aluno")),
               'label_y'  => $this->getChartText(strip_tags("" .  $this->Ini->Nm_lang['lang_othr_rows'] . "")),
               'format'   => $this->formatChartValue(0),
           ),
           '2|0' => array(
               ...
               'show_sub' => true,
               'subtitle' => "",
               'label_x'  => $this->getChartText(strip_tags("Resultado")),
               'label_y'  => $this->getChartText(strip_tags("" .  $this->Ini->Nm_lang['lang_othr_rows'] . "")),
               'format'   => $this->formatChartValue(0),
           ),
           'T|0' => array(
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['avaliacao_teste_feito']['pivot_charts']    = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['avaliacao_teste_feito']['comb_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['avaliacao_teste_feito']['comb_table_def']  = array();
           ...
           foreach ($a_totals as $i_total => $values)
           {
               ...
               if (isset($this->comp_chart_config[$key_config]))
               {
                   ...
                   foreach ($a_keys as $tmp_key)
                   {
                       ...
                       $xml_links[]  = 'sc_avaliacao_teste_feito_' . session_id() . '_!!!' . implode('_', array_merge(array($group + 1, $i_total), $link_index)) . '!!!.xml';
                   }
                   ...
                   $this->comp_chart_data[$key_data]['xml']        = 'sc_avaliacao_teste_feito_' . session_id() . '_!!!' . implode('_', array_merge(array($group, $i_total), $param)) . '!!!.xml';
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['avaliacao_teste_feito']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['avaliacao_teste_feito']['arr_export']['data']  = $this->build_data;
           return;
       }
       ...
       foreach ($this->build_data as $lines)
       {
           ...
           foreach ($lines as $columns)
           {
               ...
               if (0 <= $columns['level'])
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['avaliacao_teste_feito']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['avaliacao_teste_feito']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['avaliacao_teste_feito']['embutida'])
                   {
               ...
               $chart   = (($_SESSION['sc_session'][$this->Ini->sc_page]['avaliacao_teste_feito']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['avaliacao_teste_feito']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['avaliacao_teste_feito']['embutida']) && isset($columns['chart']) && '' != $columns['chart'] && isset($this->comp_chart_data[ $columns['chart'] ]))
   ...
   function resumo_init()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         ...
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['avaliacao_teste_feito']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
         {
      ...
      elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['avaliacao_teste_feito']['opcao'] == "pdf" || $this->Print_All)
      {
          $this->monta_cabecalho();
      }
   }
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['avaliacao_teste_feito']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['avaliacao_teste_feito']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
...
$nm_saida->saida("     " . $res_sem_reg . "</TD> </TR>\r\n");
   ...
   function inicializa_vars()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         require_once($this->Ini->path_aplicacao . "avaliacao_teste_feito_total.class.php"); 
      }
      ...
      if ($this->Print_All)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['avaliacao_teste_feito']['opcao'] = "print";
      ...
      $this->total   = new avaliacao_teste_feito_total($this->Ini->sc_page);
   ...
   function totaliza()
   {
      $this->total->resumo_desempenho("res", $this->array_total_u512969981_questoes_teste, $this->array_total_u512969981_questoes_aluno, $this->array_total_resp);
      ksort($this->array_total_u512969981_questoes_teste);
      ksort($this->array_total_u512969981_questoes_aluno);
      ksort($this->array_total_resp);
      if ("out" == $this->NM_tipo)
      {
         $this->total->quebra_geral();
      }
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['avaliacao_teste_feito']['doc_word'])
{
      ...
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_avaliacao_teste_feito_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['avaliacao_teste_feito']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['avaliacao_teste_feito']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_avaliacao_teste_feito_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['avaliacao_teste_feito']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['avaliacao_teste_feito']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_avaliacao_teste_feito_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['avaliacao_teste_feito']['num_css'] . '.css');
...
$nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "avaliacao_teste_feito/avaliacao_teste_feito_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\">\r\n");
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['avaliacao_teste_feito']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['avaliacao_teste_feito']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['avaliacao_teste_feito']['doc_word'])
      { 
          $nm_saida->saida("      <STYLE>\r\n");
   ...
   function monta_barra_top_normal()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['avaliacao_teste_feito']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['avaliacao_teste_feito']['embutida'])
      {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['pdf'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bpdf", "", "", "Rpdf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "avaliacao_teste_feito/avaliacao_teste_feito_config_pdf.php?nm_opc=pdf_res&nm_target=0&nm_cor=cor&papel=1&orientacao=1&bookmarks=1&largura=1200&conf_larg=S&conf_fonte=10&grafico=S&language=pt_br&conf_socor=S&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['word'] == "on" && !$this->NM_res_sem_reg)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bword", "", "", "Rrtf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "avaliacao_teste_feito/avaliacao_teste_feito_config_word.php?nm_cor=AM&language=pt_br&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['print'] == "on" && !$this->NM_res_sem_reg)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "Rprint_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "avaliacao_teste_feito/avaliacao_teste_feito_config_print.php?nm_opc=resumo&nm_cor=AM&language=pt_br&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
              $nm_saida->saida("           </td></tr>\r\n");
      ...
      {
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bconf_graf", "", "", "Rgraf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "avaliacao_teste_feito/avaliacao_teste_feito_config_graf_flash.php?nome_apl=avaliacao_teste_feito&campo_apl=nm_resumo_graf&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=pt_br&tp_apl=cns_htm&KeepThis=true&TB_iframe=true&height=450&width=400&modal=true", "", "only_text", "text_right", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
      }
      if (!$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
      ...
      if (!$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
         ...
         if (is_file("avaliacao_teste_feito_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'avaliacao_teste_feito_config_pivot.php?nome_apl=avaliacao_teste_feito&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=pt_br&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
      ...
      $nm_saida->saida("   {\r\n");
      $nm_saida->saida("       window.open('" . $this->Ini->path_link . "avaliacao_teste_feito/avaliacao_teste_feito_iframe_prt.php?path_botoes=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&script_case_session=" . session_id() . "&opcao=res_print&cor_print=' + cor,'','location=no,menubar,resizable,scrollbars,status=no,toolbar');\r\n");
      $nm_saida->saida("   }\r\n");
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['avaliacao_teste_feito']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['avaliacao_teste_feito']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_avaliacao_teste_feito_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['avaliacao_teste_feito']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "avaliacao_teste_feito/avaliacao_teste_feito_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       $this->Print_All = $_SESSION['sc_session'][$this->Ini->sc_page]['avaliacao_teste_feito']['print_all'];
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['avaliacao_teste_feito']['pdf_res'])
       {
           $nm_saida->saida("<TR>\r\n");
           $nm_saida->saida("<TD style=\"padding: 0px\">\r\n");
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['avaliacao_teste_feito']['print_all'])
       {
           $tp_quebra = "<table><tr><td style=\"border-width:0;height:1px;padding:0\"><span style=\"display: none;\">&nbsp;</span><div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></td></tr></table>";
       }
...
//--- 
 function grafico_pdf()
 {
   ...
   $this->Graf->Ini    = $this->Ini;
   $this->Graf->Lookup = $this->Lookup;
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['avaliacao_teste_feito']['pivot_charts']))
   {
       ...
       $iChartCount = 1;
       $iChartTotal = sizeof($_SESSION['sc_session'][$this->Ini->sc_page]['avaliacao_teste_feito']['pivot_charts']);
      ...
      if (!isset($this->progress_fp) || !$this->progress_fp)
      {
       ...
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['avaliacao_teste_feito']['pivot_charts'] as $chart_index => $chart_data)
       {
       ...
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['avaliacao_teste_feito']['charts_html']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['avaliacao_teste_feito']['charts_html'])
       {
            $nm_saida->saida("<script type=\"text/javascript\">\r\n");
            $nm_saida->saida("{$_SESSION['sc_session'][$this->Ini->sc_page]['avaliacao_teste_feito']['charts_html']}\r\n");
            $nm_saida->saida("</script>\r\n");
       }
   }
   $nm_saida->saida("</body>\r\n");
...
//--- 
 ...
 {
   global $nm_saida, $nm_lang;
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['avaliacao_teste_feito']['chart_list']))
   {
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['avaliacao_teste_feito']['chart_list'] as $arr_chart)
       {
           $nm_saida->saida("<table><tr><td style=\"border-width:0;height:1px;padding:0\"><span style=\"display: none;\">&nbsp;</span><div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></td></tr></table>\r\n");
       $nm_saida->saida("<b><div style=\"height:1px;overflow:hidden\"><H1 style=\"font-size:0;padding:1px\">" . $this->Ini->Nm_lang['lang_btns_chrt_pdff_hint'] . "</H1></div></b>\r\n");
           $nm_saida->saida("<table><tr><td>\r\n");
...
//--- 
   ...
   function monta_cabecalho()
   {
      ...
      { 
        ...
        if ($_SESSION['scriptcase']['charset'] != "UTF-8")
        {
          ...
          $u512969981_questoes_aluno = $Busca_temp['u512969981_questoes_aluno']; 
          $tmp_pos = strpos($u512969981_questoes_aluno, "##@@");
          if ($tmp_pos !== false)
          {
              $u512969981_questoes_aluno = substr($u512969981_questoes_aluno, 0, $tmp_pos);
          }
          $u512969981_questoes_teste = $Busca_temp['u512969981_questoes_teste']; 
   ...
   //---- 
   function adiciona_registro($quebra_u512969981_questoes_teste, $quebra_u512969981_questoes_aluno, $quebra_resp, $quebra_u512969981_questoes_teste_orig, $quebra_u512969981_questoes_aluno_orig, $quebra_resp_orig)
   {
      //----- Teste
      if (!isset($this->array_total_u512969981_questoes_teste[$quebra_u512969981_questoes_teste_orig]))
      {
         $this->array_total_u512969981_questoes_teste[$quebra_u512969981_questoes_teste_orig][0] = 1;
         $this->array_total_u512969981_questoes_teste[$quebra_u512969981_questoes_teste_orig][1] = $quebra_u512969981_questoes_teste;
         $this->array_total_u512969981_questoes_teste[$quebra_u512969981_questoes_teste_orig][2] = $quebra_u512969981_questoes_teste_orig;
      }
      else
      {
         $this->array_total_u512969981_questoes_teste[$quebra_u512969981_questoes_teste_orig][0]++;
      }
      //----- Aluno
      if (!isset($this->array_total_u512969981_questoes_aluno[$quebra_u512969981_questoes_teste_orig][$quebra_u512969981_questoes_aluno_orig]))
      {
         $this->array_total_u512969981_questoes_aluno[$quebra_u512969981_questoes_teste_orig][$quebra_u512969981_questoes_aluno_orig][0] = 1;
         $this->array_total_u512969981_questoes_aluno[$quebra_u512969981_questoes_teste_orig][$quebra_u512969981_questoes_aluno_orig][1] = $quebra_u512969981_questoes_aluno;
         $this->array_total_u512969981_questoes_aluno[$quebra_u512969981_questoes_teste_orig][$quebra_u512969981_questoes_aluno_orig][2] = $quebra_u512969981_questoes_aluno_orig;
      }
      else
      {
         $this->array_total_u512969981_questoes_aluno[$quebra_u512969981_questoes_teste_orig][$quebra_u512969981_questoes_aluno_orig][0]++;
      }
      //----- Resultado
      if (!isset($this->array_total_resp[$quebra_u512969981_questoes_teste_orig][$quebra_u512969981_questoes_aluno_orig][$quebra_resp_orig]))
      {
         $this->array_total_resp[$quebra_u512969981_questoes_teste_orig][$quebra_u512969981_questoes_aluno_orig][$quebra_resp_orig][0] = 1;
         $this->array_total_resp[$quebra_u512969981_questoes_teste_orig][$quebra_u512969981_questoes_aluno_orig][$quebra_resp_orig][1] = $quebra_resp;
         $this->array_total_resp[$quebra_u512969981_questoes_teste_orig][$quebra_u512969981_questoes_aluno_orig][$quebra_resp_orig][2] = $quebra_resp_orig;
      }
      else
      {
         $this->array_total_resp[$quebra_u512969981_questoes_teste_orig][$quebra_u512969981_questoes_aluno_orig][$quebra_resp_orig][0]++;
      }
   }
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     { 
         $nmgp_select = "SELECT u512969981_questoes.u512969981_questao as cmp_maior_30_1, u512969981_questoes.aluno as u512969981_questoes_aluno, u512969981_questoes.teste as u512969981_questoes_teste, if(u512969981_gabarito.alternativa_id_alternativa = u512969981_respostas.alternativa_id_alternativa,'CERTO','ERRADA') as resp from " . $this->Ini->nm_tabela; 
     } 
     ...
     $nmgp_order_by = " order by  u512969981_questoes.teste asc, u512969981_questoes.aluno asc, if(u512969981_gabarito.alternativa_id_alternativa = u512969981_respostas.alternativa_id_alternativa,'CERTO','ERRADA') asc"; 
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->u512969981_questoes_u512969981_questao = $rs_res->fields[0] ;  
            $this->u512969981_questoes_aluno = $rs_res->fields[1] ;  
            $this->u512969981_questoes_teste = $rs_res->fields[2] ;  
            $this->resp = $rs_res->fields[3] ;  
            $this->u512969981_questoes_teste_orig = $this->u512969981_questoes_teste;
            $this->u512969981_questoes_aluno_orig = $this->u512969981_questoes_aluno;
            $this->resp_orig = $this->resp;
            $this->look_u512969981_questoes_aluno = $this->u512969981_questoes_aluno; 
            $this->Lookup->lookup_u512969981_questoes_aluno($this->look_u512969981_questoes_aluno, $this->u512969981_questoes_aluno) ; 
            $this->look_u512969981_questoes_teste = $this->u512969981_questoes_teste; 
            $this->Lookup->lookup_u512969981_questoes_teste($this->look_u512969981_questoes_teste, $this->u512969981_questoes_teste) ; 
            $_SESSION['scriptcase']['avaliacao_teste_feito']['contr_erro'] = 'on';
 if($this->resp  == 'ERRADA')
{
	$this->NM_field_style["u512969981_questoes_u512969981_questao"] = "background-color:#ffffcc;font-size:;color:#ffffff;font-family:;font-weight:bold;";
...
$_SESSION['scriptcase']['avaliacao_teste_feito']['contr_erro'] = 'off'; 
            $this->u512969981_questoes_aluno = $this->look_u512969981_questoes_aluno ;
            $this->u512969981_questoes_teste = $this->look_u512969981_questoes_teste ;
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->u512969981_questoes_teste, $this->u512969981_questoes_aluno, $this->resp, $this->u512969981_questoes_teste_orig,  $this->u512969981_questoes_aluno_orig,  $this->resp_orig);
            }
   }
//
