<?php
   ...
   if (!function_exists("NM_is_utf8"))
   {
    ...
    $Ord_Cmp = new avaliacao_teste_feito_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class avaliacao_teste_feito_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels     = array();
   $tab_ger_campos['u512969981_questoes_u512969981_questao'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['u512969981_questoes_u512969981_questao'] = "cmp_maior_30_1";
       $tab_converte["cmp_maior_30_1"]   = "u512969981_questoes_u512969981_questao";
   }
   else
   {
       $tab_def_campos['u512969981_questoes_u512969981_questao'] = "u512969981_questoes.u512969981_questao";
       $tab_converte["u512969981_questoes.u512969981_questao"]   = "u512969981_questoes_u512969981_questao";
   }
   $tab_labels["u512969981_questoes_u512969981_questao"]   = (isset($_SESSION['sc_session'][$sc_init]['avaliacao_teste_feito']['labels']["u512969981_questoes_u512969981_questao"])) ? $_SESSION['sc_session'][$sc_init]['avaliacao_teste_feito']['labels']["u512969981_questoes_u512969981_questao"] : "Questões";
   $tab_ger_campos['resp'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['resp'] = "resp";
       $tab_converte["resp"]   = "resp";
   }
   else
   {
       $tab_def_campos['resp'] = "if(u512969981_gabarito.alternativa_id_alternativa = u512969981_respostas.alternativa_id_alternativa,'CERTO','ERRADA')";
       $tab_converte["if(u512969981_gabarito.alternativa_id_alternativa = u512969981_respostas.alternativa_id_alternativa,'CERTO','ERRADA')"]   = "resp";
   }
   $tab_labels["resp"]   = (isset($_SESSION['sc_session'][$sc_init]['avaliacao_teste_feito']['labels']["resp"])) ? $_SESSION['sc_session'][$sc_init]['avaliacao_teste_feito']['labels']["resp"] : "Resultado";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['avaliacao_teste_feito']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['avaliacao_teste_feito']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['avaliacao_teste_feito']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['avaliacao_teste_feito']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['avaliacao_teste_feito']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['avaliacao_teste_feito']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['avaliacao_teste_feito']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['avaliacao_teste_feito']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['avaliacao_teste_feito']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "avaliacao_teste_feito_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['avaliacao_teste_feito']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['avaliacao_teste_feito']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
