...
<?php
   ...
   function inicializa_vars()
   {
      ...
      {
         $this->label[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['avaliacao_teste_feito']['contr_label_graf']['u512969981_questoes_aluno'];
      }
      $this->label[1] = "Resposta";
      ...
      {
         $this->label[1] = $_SESSION['sc_session'][$this->Ini->sc_page]['avaliacao_teste_feito']['contr_label_graf']['resp'];
      }
   }
