...
class avaliacao_teste_feito_resumo
{
   ...
   function completeMatrix()
   {
       ...
       //-----
       foreach ($this->array_total_u512969981_questoes_aluno as $i_u512969981_questoes_aluno => $d_u512969981_questoes_aluno) {
           if (!in_array($i_u512969981_questoes_aluno, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_u512969981_questoes_aluno[2] ] = $d_u512969981_questoes_aluno[1];
               $this->comp_label[0][ $d_u512969981_questoes_aluno[2] ] = $d_u512969981_questoes_aluno[1];
           }
           foreach ($this->array_total_resp[$i_u512969981_questoes_aluno] as $i_resp => $d_resp) {
               if (!in_array($i_resp, $this->comp_label[1][ $d_u512969981_questoes_aluno[2] ], true)) {
                   $this->comp_index[1][ $d_resp[2] ] = $d_resp[1];
                   $this->comp_label[1][ $d_u512969981_questoes_aluno[2] ][ $d_resp[2] ] = $d_resp[1];
               }
           }
       }
       ...
       //-----
       foreach ($this->comp_label[0] as $i_u512969981_questoes_aluno => $l_u512969981_questoes_aluno) {
           if (isset($this->array_total_u512969981_questoes_aluno[$i_u512969981_questoes_aluno])) {
               $this->comp_group[$i_u512969981_questoes_aluno] = array();
           }
           foreach ($this->comp_label[1][$i_u512969981_questoes_aluno] as $i_resp => $l_resp) {
               if (isset($this->array_total_resp[$i_u512969981_questoes_aluno][$i_resp])) {
                   $this->comp_group[$i_u512969981_questoes_aluno][$i_resp] = array();
               }
           }
       }
   ...
   function buildChart()
   {
       ...
       $this->comp_chart_config = array(
           ...
           '1|0' => array(
               ...
               'show_sub' => true,
               'subtitle' => "",
               'label_x'  => $this->getChartText(strip_tags("Resposta")),
               'label_y'  => $this->getChartText(strip_tags("" .  $this->Ini->Nm_lang['lang_othr_rows'] . "")),
               'format'   => $this->formatChartValue(0),
           ),
           'T|0' => array(
...
$nm_saida->saida("     " . $res_sem_reg . "</TD> </TR>\r\n");
   ...
   function totaliza()
   {
      $this->total->resumo_q("res", $this->array_total_u512969981_questoes_aluno, $this->array_total_resp);
...
//--- 
   ...
   //---- 
   function adiciona_registro($quebra_u512969981_questoes_aluno, $quebra_resp, $quebra_u512969981_questoes_aluno_orig, $quebra_resp_orig)
   {
      //----- Aluno
      if (!isset($this->array_total_u512969981_questoes_aluno[$quebra_u512969981_questoes_aluno_orig]))
      {
         $this->array_total_u512969981_questoes_aluno[$quebra_u512969981_questoes_aluno_orig][0] = 1;
         $this->array_total_u512969981_questoes_aluno[$quebra_u512969981_questoes_aluno_orig][1] = $quebra_u512969981_questoes_aluno;
         $this->array_total_u512969981_questoes_aluno[$quebra_u512969981_questoes_aluno_orig][2] = $quebra_u512969981_questoes_aluno_orig;
      }
      else
      {
         $this->array_total_u512969981_questoes_aluno[$quebra_u512969981_questoes_aluno_orig][0]++;
      }
      //----- Resposta
      if (!isset($this->array_total_resp[$quebra_u512969981_questoes_aluno_orig][$quebra_resp_orig]))
      {
         $this->array_total_resp[$quebra_u512969981_questoes_aluno_orig][$quebra_resp_orig][0] = 1;
         $this->array_total_resp[$quebra_u512969981_questoes_aluno_orig][$quebra_resp_orig][1] = $quebra_resp;
         $this->array_total_resp[$quebra_u512969981_questoes_aluno_orig][$quebra_resp_orig][2] = $quebra_resp_orig;
      }
      else
      {
         $this->array_total_resp[$quebra_u512969981_questoes_aluno_orig][$quebra_resp_orig][0]++;
      }
   }
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     { 
         $nmgp_select = "SELECT u512969981_questoes.aluno as u512969981_questoes_aluno, u512969981_respostas.alternativa_id_alternativa as cmp_maior_30_1, u512969981_gabarito.alternativa_id_alternativa as cmp_maior_30_2, if(u512969981_gabarito.alternativa_id_alternativa = u512969981_respostas.alternativa_id_alternativa,'CERTO','ERRADA') as resp from " . $this->Ini->nm_tabela; 
     } 
     ...
     $nmgp_order_by = " order by  u512969981_questoes.aluno asc, if(u512969981_gabarito.alternativa_id_alternativa = u512969981_respostas.alternativa_id_alternativa,'CERTO','ERRADA') asc"; 
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->u512969981_questoes_aluno = $rs_res->fields[0] ;  
            $this->u512969981_respostas_alternativa_id_alternativa = $rs_res->fields[1] ;  
            $this->u512969981_gabarito_alternativa_id_alternativa = $rs_res->fields[2] ;  
            ...
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->u512969981_questoes_aluno, $this->resp, $this->u512969981_questoes_aluno_orig,  $this->resp_orig);
            }
   }
//
