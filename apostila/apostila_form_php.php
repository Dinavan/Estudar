...
class apostila_form_php
{
   ...
   function init()
   {
      ...
      //check prod
      if(!isset($_SESSION['scriptcase']['apostila']['glo_nm_path_prod']) || empty($_SESSION['scriptcase']['apostila']['glo_nm_path_prod']))
      {
...
<?php
      ...
      {
         foreach($_SESSION['scriptcase']['sc_def_menu']['apostila'] as $id_item => $arr_item)
         {
...
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 3.2 Final//EN">
      ...
      <html><body>
        <form name="fmenu" method="post" action="<?php echo NM_encode_input($apl_run); ?>">
          ...
          <input type=hidden name="nm_apl_menu" value="apostila"> 
<?php
      if (isset($_SESSION['scriptcase']['menu_mobile']) && $_SESSION['scriptcase']['menu_mobile'] == "apostila")
      {
?>
...
<?php
      ...
      {
?>
          window.history.pushState('Object', 'apostila', '<?php echo $this->nm_location ?>');
<?php
      }
      if ($link_url)
      {
...
SC_dir_app_ini('Estudar');
$controle = new apostila_form_php();
$controle->init();
?>
